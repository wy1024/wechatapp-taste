...
*/
  ...
  INSERT INTO dbo.Restaurants VALUES ('Coffee shop', 'Seattle', '1234567', 'Jason', NULL);
  INSERT INTO dbo.Restaurants VALUES ('Hot pepper', 'SF', '234567', 'Tommy', NULL);
  ...
  INSERT INTO dbo.Dishes VALUES (2, 2, N'甜豆花', N'豆花是甜的', N'甜,柔软', N'豆腐,豆花,糖,红豆', N'甜品', 5, NULL);
  INSERT INTO dbo.Dishes VALUES (2, 2, N'抹茶冰激凌', N'清凉夏日', N'冰凉,甜腻', N'抹茶,冰激凌', N'甜品', 4.8, NULL);
